...
ALTER TABLE UNIT_LEVEL ADD CONSTRAINT UNIT_LEVEL_FK FOREIGN KEY (UNIT_NAME) REFERENCES UNIT_CASTLE (UNIT_NAME);
ALTER TABLE UNIT_INFO ADD CONSTRAINT UNIT_LEVEL_INFO_FK FOREIGN KEY (UNIT_NAME) REFERENCES UNIT_LEVEL (UNIT_NAME);
